...
const (
	ContactService_Create_FullMethodName = "/contact_proto.ContactService/Create"
	ContactService_Get_FullMethodName    = "/contact_proto.ContactService/Get"
	ContactService_Update_FullMethodName = "/contact_proto.ContactService/Update"
	ContactService_Delete_FullMethodName = "/contact_proto.ContactService/Delete"
	ContactService_List_FullMethodName   = "/contact_proto.ContactService/List"
)
...
func (c *contactServiceClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
...
func (UnimplementedContactServiceServer) Create(context.Context, *CreateRequest) (*CreateResponse, error) {
...
var ContactService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "contact_proto.ContactService",
	...
	Metadata: "veyron_wpp_bot/protos/contact.proto",
}
