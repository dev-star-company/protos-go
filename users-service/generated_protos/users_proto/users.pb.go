...
func (x *VerifyPasswordResponse) Reset() {
	*x = VerifyPasswordResponse{}
	mi := &file_users_service_protos_users_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VerifyPasswordResponse) Descriptor() ([]byte, []int) {
	return file_users_service_protos_users_proto_rawDescGZIP(), []int{15}
}
...
const file_users_service_protos_users_proto_rawDesc = "" +
	"\n" +
	" users-service/protos/users.proto\x12\vusers_proto\"\xa3\x02\n" +
	"\x05Phone\x12\x0e\n" +
...
var file_users_service_protos_users_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
...
func file_users_service_protos_users_proto_init() {
	...
	file_users_service_protos_users_proto_msgTypes[3].OneofWrappers = []any{}
	file_users_service_protos_users_proto_msgTypes[8].OneofWrappers = []any{}
	file_users_service_protos_users_proto_msgTypes[10].OneofWrappers = []any{}
	file_users_service_protos_users_proto_msgTypes[14].OneofWrappers = []any{}
	file_users_service_protos_users_proto_msgTypes[15].OneofWrappers = []any{}
	type x struct{}
