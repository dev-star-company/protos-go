...
func (x *Images) GetEntityId() uint32 {
	if x != nil {
		return x.EntityId
	}
	return 0
...
func (x *CreateRequest) GetEntityId() uint32 {
	if x != nil {
		return x.EntityId
	}
	return 0
...
func (x *CreateResponse) GetEntityId() uint32 {
	if x != nil {
		return x.EntityId
	}
	return 0
...
func (x *GetResponse) GetEntityId() uint32 {
	if x != nil {
		return x.EntityId
	}
	return 0
...
type UpdateRequest struct {
	...
	EntityId      *uint32                `protobuf:"varint,3,opt,name=entity_id,json=entityId,proto3,oneof" json:"entity_id,omitempty"`
	IsMain        *bool                  `protobuf:"varint,4,opt,name=is_main,json=isMain,proto3,oneof" json:"is_main,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateRequest) GetEntityId() uint32 {
...
func (x *UpdateResponse) GetEntityId() uint32 {
	if x != nil {
		return x.EntityId
	}
	return 0
...
func (x *ListRequest) GetEntityId() uint32 {
	if x != nil && x.EntityId != nil {
		return *x.EntityId
	}
	return 0
...
const file_images_service_protos_images_proto_rawDesc = "" +
	"\n" +
	"\"images_service/protos/images.proto\x12\fimages_proto\"\xb0\x02\n" +
	"\x06Images\x12\x0e\n" +
	...
	"\tentity_id\x18\b \x01(\rR\bentityId\x12\x17\n" +
	"\ais_main\x18\t \x01(\bR\x06isMainB\r\n" +
	"\v_deleted_atB\r\n" +
	"\v_deleted_by\"h\n" +
	"\rCreateRequest\x12!\n" +
	"\frequester_id\x18\x01 \x01(\rR\vrequesterId\x12\x1b\n" +
	"\tentity_id\x18\x02 \x01(\rR\bentityId\x12\x17\n" +
	"\ais_main\x18\x03 \x01(\bR\x06isMain\"\xa3\x02\n" +
	...
	"\n" +
	"GetRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\"\xa0\x02\n" +
	"\vGetResponse\x12!\n" +
	"\frequester_id\x18\x01 \x01(\rR\vrequesterId\x12\x1b\n" +
	"\tentity_id\x18\x02 \x01(\rR\bentityId\x12\x17\n" +
	"\ais_main\x18\x03 \x01(\bR\x06isMain\x12\x1d\n" +
	...
	"updated_by\x18\b \x01(\rR\tupdatedBy\x12\x1d\n" +
	"\n" +
	"deleted_by\x18\t \x01(\rR\tdeletedBy\"\x9c\x01\n" +
	"\rUpdateRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12!\n" +
	"\frequester_id\x18\x02 \x01(\rR\vrequesterId\x12 \n" +
	"\tentity_id\x18\x03 \x01(\rH\x00R\bentityId\x88\x01\x01\x12\x1c\n" +
	"\ais_main\x18\x04 \x01(\bH\x01R\x06isMain\x88\x01\x01B\f\n" +
	"\n" +
	"_entity_idB\n" +
	"\n" +
	"\b_is_main\"\xa3\x02\n" +
	...
	"\tentity_id\x18\x03 \x01(\rH\x02R\bentityId\x88\x01\x01\x12\x1c\n" +
	"\ais_main\x18\x04 \x01(\bH\x03R\x06isMain\x88\x01\x01\x12,\n" +
	"\x0finclude_deleted\x18\x05 \x01(\bH\x04R\x0eincludeDeleted\x88\x01\x01\x124\n" +
	"\aorderby\x18\x06 \x01(\v2\x15.images_proto.OrderByH\x05R\aorderby\x88\x01\x01B\b\n" +
	"\x06_limitB\t\n" +
	"\a_offsetB\f\n" +
	"\n" +
	"_entity_idB\n" +
