...
const file_protos_user_proto_rawDesc = "" +
	"\n" +
	"\x11protos/user.proto\x12\vusers_proto\"\xc1\x02\n" +
	"\x05Phone\x12\x0e\n" +
...
var file_protos_user_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
...
func file_protos_user_proto_init() {
	...
	file_protos_user_proto_msgTypes[8].OneofWrappers = []any{}
	file_protos_user_proto_msgTypes[10].OneofWrappers = []any{}
	file_protos_user_proto_msgTypes[14].OneofWrappers = []any{}
	file_protos_user_proto_msgTypes[15].OneofWrappers = []any{}
	type x struct{}
