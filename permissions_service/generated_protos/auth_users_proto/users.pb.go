...
func (x *VerifyPasswordResponse) Reset() {
	*x = VerifyPasswordResponse{}
	mi := &file_protos_users_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VerifyPasswordResponse) Descriptor() ([]byte, []int) {
	return file_protos_users_proto_rawDescGZIP(), []int{16}
}
...
var file_protos_users_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
...
func file_protos_users_proto_init() {
	...
	file_protos_users_proto_msgTypes[4].OneofWrappers = []any{}
	file_protos_users_proto_msgTypes[9].OneofWrappers = []any{}
	file_protos_users_proto_msgTypes[11].OneofWrappers = []any{}
	file_protos_users_proto_msgTypes[15].OneofWrappers = []any{}
	file_protos_users_proto_msgTypes[16].OneofWrappers = []any{}
	type x struct{}
