...
type UpdateRequest struct {
	...
	RequesterId   uint32                 `protobuf:"varint,7,opt,name=requester_id,json=requesterId,proto3" json:"requester_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_permissions_service_protos_permission_proto_rawDesc = "" +
	...
	"\frequester_id\x18\x06 \x01(\rR\vrequesterId\"\xca\x01\n" +
	...
	"\frequester_id\x18\x06 \x01(\rR\vrequesterId\"B\n" +
	...
	"\x05count\x18\x02 \x01(\rR\x05count\"\xba\x02\n" +
	...
	"\frequester_id\x18\a \x01(\rR\vrequesterIdB\a\n" +
	"\x05_nameB\x0e\n" +
	"\f_descriptionB\x10\n" +
	"\x0e_internal_nameB\r\n" +
	"\v_service_idB\f\n" +
