...
func (x *ServiceDto) GetUpdatedAt() string {
	if x != nil {
		return x.UpdatedAt
	}
	return ""
...
func (x *ServiceDto) GetCreatedBy() uint32 {
	if x != nil {
		return x.CreatedBy
	}
	return 0
...
func (x *ServiceDto) GetUpdatedBy() uint32 {
	if x != nil {
		return x.UpdatedBy
	}
	return 0
...
func (x *ServiceDto) GetDeletedBy() uint32 {
...
type ListResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Rows          []*ServiceDto          `protobuf:"bytes,1,rep,name=rows,proto3" json:"rows,omitempty"`
...
const file_permissions_service_protos_service_proto_rawDesc = "" +
	"\n" +
	"(permissions_service/protos/service.proto\x12\rservice_proto\"\xf6\x02\n" +
	"\n" +
	"ServiceDto\x12\x0e\n" +
	...
	"\x06offset\x18\x04 \x01(\rR\x06offset\"D\n" +
	"\vGetResponse\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12!\n" +
	"\frequester_id\x18\x02 \x01(\rR\vrequesterId\"\xf6\x02\n" +
	...
	"\border_by\x18\x05 \x01(\v2\x16.service_proto.OrderByH\x04R\aorderBy\x88\x01\x01\x12%\n" +
	...
	"\v_created_at\"S\n" +
	"\fListResponse\x12-\n" +
	"\x04rows\x18\x01 \x03(\v2\x19.service_proto.ServiceDtoR\x04rows\x12\x14\n" +
	...
	"\x04name\x18\x01 \x01(\tR\x04name\x12!\n" +
	"\frequester_id\x18\x02 \x01(\rR\vrequesterId2\xe4\x02\n" +
