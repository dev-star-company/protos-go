...
func (x *FirstLogin) GetUserUuid() string {
	if x != nil {
		return x.UserUuid
	}
	return ""
...
const file_permissions_service_protos_first_login_proto_rawDesc = "" +
	"\n" +
	",permissions_service/protos/first_login.proto\x12\x11first_login_proto\"\xbb\x02\n" +
	"\n" +
	"FirstLogin\x12\x0e\n" +
	...
	"successful\x18\x02 \x01(\bR\n" +
	"successful\x12%\n" +
	"\x0erequester_uuid\x18\x03 \x01(\tR\rrequesterUuid\"\xc9\x02\n" +
	...
	"\border_by\x18\x04 \x01(\v2\x1a.first_login_proto.OrderByH\x03R\aorderBy\x88\x01\x01\x12 \n" +
	...
	"successful\x18\x02 \x01(\bR\n" +
	"successful\x12%\n" +
	"\x0erequester_uuid\x18\x03 \x01(\tR\rrequesterUuid2\x8f\x03\n" +
