...
const file_protos_first_login_proto_rawDesc = "" +
	...
	"\x0erequester_uuid\x18\x02 \x01(\tR\rrequesterUuid\"P\n" +
	...
	"\auser_id\x18\x01 \x01(\rR\x06userId\x12%\n" +
	"\x0erequester_uuid\x18\x02 \x01(\tR\rrequesterUuid\"\x8f\x02\n" +
	...
	"\x0erequester_uuid\x18\x03 \x01(\tR\rrequesterUuidB\n" +
	"\n" +
	"\b_user_id\"P\n" +
	"\x0eUpdateResponse\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\rR\x06userId\x12%\n" +
	"\x0erequester_uuid\x18\x02 \x01(\tR\rrequesterUuid2\x8f\x03\n" +
