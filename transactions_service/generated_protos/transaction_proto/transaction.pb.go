...
type CreateRequest struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	OriginAccountId      *uint32                `protobuf:"varint,1,opt,name=origin_account_id,json=originAccountId,proto3,oneof" json:"origin_account_id,omitempty"`
...
const file_transactions_service_protos_transaction_proto_rawDesc = "" +
	"\n" +
	"-transactions_service/protos/transaction.proto\x12\x11transaction_proto\"\xac\x03\n" +
	...
	"\x11origin_account_id\x18\x04 \x01(\rH\x01R\x0foriginAccountId\x88\x01\x01\x124\n" +
	...
	"\v_deleted_atB\x14\n" +
	"\x12_origin_account_idB\x0e\n" +
	"\f_observation\"\xcc\x02\n" +
	"\rCreateRequest\x12/\n" +
	"\x11origin_account_id\x18\x01 \x01(\rH\x00R\x0foriginAccountId\x88\x01\x01\x124\n" +
	...
	"successful\x12%\n" +
	"\vobservation\x18\a \x01(\tH\x01R\vobservation\x88\x01\x01B\x14\n" +
	"\x12_origin_account_idB\x0e\n" +
	"\f_observation\"\xf6\x02\n" +
	...
	"successful\x18\x06 \x01(\bR\n" +
	"successful\x12 \n" +
	"\vobservation\x18\a \x01(\tR\vobservation\x12\x1d\n" +
	"\n" +
	"created_at\x18\b \x01(\tR\tcreatedAt\x12\x1d\n" +
	"\n" +
	"deleted_at\x18\t \x01(\tR\tdeletedAtB\x14\n" +
	"\x12_origin_account_id\"\x1c\n" +
	"\n" +
	"GetRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\"\xf3\x02\n" +
	"\vGetResponse\x12/\n" +
	"\x11origin_account_id\x18\x01 \x01(\rH\x00R\x0foriginAccountId\x88\x01\x01\x124\n" +
	"\x16destination_account_id\x18\x02 \x01(\rR\x14destinationAccountId\x12.\n" +
	"\x13transaction_type_id\x18\x03 \x01(\rR\x11transactionTypeId\x12\x16\n" +
	...
	"successful\x18\x06 \x01(\bR\n" +
	"successful\x12 \n" +
	"\vobservation\x18\a \x01(\tR\vobservationB\x14\n" +
	"\x12_origin_account_id\"\x1f\n" +
...
func file_transactions_service_protos_transaction_proto_init() {
	...
	file_transactions_service_protos_transaction_proto_msgTypes[2].OneofWrappers = []any{}
	file_transactions_service_protos_transaction_proto_msgTypes[4].OneofWrappers = []any{}
	file_transactions_service_protos_transaction_proto_msgTypes[5].OneofWrappers = []any{}
	file_transactions_service_protos_transaction_proto_msgTypes[6].OneofWrappers = []any{}
