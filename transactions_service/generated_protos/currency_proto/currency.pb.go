...
type Currency struct {
	...
	RequesterUuid  string                 `protobuf:"bytes,13,opt,name=requester_uuid,json=requesterUuid,proto3" json:"requester_uuid,omitempty"`
...
func (x *Currency) GetRequesterUuid() string {
	if x != nil {
...
const file_transactions_service_protos_currency_proto_rawDesc = "" +
	"\n" +
	"*transactions_service/protos/currency.proto\x12\x0ecurrency_proto\"\xb9\x03\n" +
	"\bCurrency\x12\x0e\n" +
	...
	"\x0erequester_uuid\x18\r \x01(\tR\rrequesterUuidB\r\n" +
	"\v_deleted_atB\r\n" +
	...
	"\x10currency_type_id\x18\x06 \x01(\rR\x0ecurrencyTypeId\"\x87\x03\n" +
	...
	"\n" +
	"GetRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\"\x84\x03\n" +
	"\vGetResponse\x12%\n" +
	"\x0erequester_uuid\x18\x01 \x01(\tR\rrequesterUuid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x16\n" +
	"\x06symbol\x18\x03 \x01(\tR\x06symbol\x12\"\n" +
	...
	"updated_by\x18\v \x01(\rR\tupdatedBy\x12\x1d\n" +
	"\n" +
	"deleted_by\x18\f \x01(\rR\tdeletedBy\"\xbc\x02\n" +
	...
	"\fabbreviation\x18\x04 \x01(\tR\fabbreviation\x12\x1a\n" +
	"\bdecimals\x18\x05 \x01(\x05R\bdecimals\x12(\n" +
	"\x10currency_type_id\x18\x06 \x01(\rR\x0ecurrencyTypeId\"F\n" +
