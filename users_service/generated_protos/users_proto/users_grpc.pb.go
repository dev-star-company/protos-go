...
const (
	...
	UsersService_FindByEmailOrPhone_FullMethodName = "/users_proto.UsersService/FindByEmailOrPhone"
)
...
type UsersServiceClient interface {
	...
	FindByEmailOrPhone(ctx context.Context, in *FindByEmailOrPhoneRequest, opts ...grpc.CallOption) (*FindByEmailOrPhoneResponse, error)
}
...
func (c *usersServiceClient) FindByEmailOrPhone(ctx context.Context, in *FindByEmailOrPhoneRequest, opts ...grpc.CallOption) (*FindByEmailOrPhoneResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FindByEmailOrPhoneResponse)
	err := c.cc.Invoke(ctx, UsersService_FindByEmailOrPhone_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsersServiceServer interface {
	...
	FindByEmailOrPhone(context.Context, *FindByEmailOrPhoneRequest) (*FindByEmailOrPhoneResponse, error)
...
func (UnimplementedUsersServiceServer) FindByEmailOrPhone(context.Context, *FindByEmailOrPhoneRequest) (*FindByEmailOrPhoneResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindByEmailOrPhone not implemented")
}
...
func _UsersService_FindByEmailOrPhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindByEmailOrPhoneRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsersServiceServer).FindByEmailOrPhone(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UsersService_FindByEmailOrPhone_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServiceServer).FindByEmailOrPhone(ctx, req.(*FindByEmailOrPhoneRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UsersService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FindByEmailOrPhone",
			Handler:    _UsersService_FindByEmailOrPhone_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "users_service/protos/users.proto",
}
